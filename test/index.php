...
<div class="container">
  ...
  <main>
    ...
    <h1 class="row mt-4 font-weight-bold text-danger">
        <div class="col">
        <button class="border rounded border-danger bg-danger">&nbsp;&nbsp;&nbsp;</button>Explore Our Products</h1>
    </div>
    </div>
    <div class="container">
    <div class="row">
        <div class="col">
            <input type="text" id="rech" onchange="rechercher()" class="form-control mt-3 mb-3 text-danger h3" placeholder="Entrer le nom de la fleur" >
