            ...
            <div class="col-md-2" style="margin-top: 100px;"> <!-- Adjust margin-top as needed -->
                <nav>
                    <ul class="nav1 justify-content-center mb-md-0">
                        ...
                        <li><a href="#" class="nav-link px-2 link-light font-weight-bold border rounded border-secondary selected">Cart</a></li>
...
<div class="col-md-11 text-light text-center h4">
 <strong>Total:
    <?= $sum['sum']?> </strong>
    <form method="post">
        <button name="buy" class="btn btn-danger">Buy Now</button>
</div>
  </body>
</html>
<?php
